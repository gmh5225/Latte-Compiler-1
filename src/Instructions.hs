...
instance Show Instruction where
  ...
  show (GetV reg ctype resultReg) =
    show resultReg ++
    " = load " ++ show ctype ++ ", " ++ show ctype ++ "* " ++ show reg ++ "\n"
  show (SetV var ctype reg) =
    "store " ++
    show ctype ++
    " " ++ show reg ++ ", " ++ show ctype ++ "* " ++ show var ++ "\n"
